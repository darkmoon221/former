...
@Component({
  ...
  templateUrl:
    '../elements/grid-layout-element/grid-layout-element.component.html',
  styleUrls: [
    '../elements/grid-layout-element/grid-layout-element.component.css',
  ],
})
...
@Component({
  ...
  templateUrl:
    '../elements/grid-column-element/grid-column-element.component.html',
  styleUrls: [
    '../elements/grid-column-element/grid-column-element.component.css',
  ],
})
